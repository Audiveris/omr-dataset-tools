# ==================================================================================================
#
#                                    m o b i l e n e t _ a v s . p y
#
# ==================================================================================================
# Prototype a model for Audiveris patch classifier using MobileNet architecture
# This code is closely derived from existing mobilenet_v2.py
# ==================================================================================================
...
if __name__ == "__main__":
    model = MobileNetV2(input_shape=(96, 48, 1), classes = 112, weights = None)
    model.compile(loss='categorical_crossentropy',optimizer='sgd', metrics=['accuracy']) # HB added
    model.summary()
    tf.keras.utils.plot_model(model, to_file='mobilenet_v2_h96w48.png', show_shapes=True, show_dtype=False,show_layer_names=True, rankdir='TB', expand_nested=False, dpi=192)
