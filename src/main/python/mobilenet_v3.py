...
if __name__ == "__main__":
    ...
    _cols = 54
    _classes = 12
    _name='headclassifierV3Small_h{}_w{}_s{}'.format(_rows, _cols, _classes)
    model = MobileNetV3Small(input_shape=(_rows, _cols, 1), minimalistic=True, classes=_classes,
        weights = None, classifier_activation='softmax', include_preprocessing=False)
